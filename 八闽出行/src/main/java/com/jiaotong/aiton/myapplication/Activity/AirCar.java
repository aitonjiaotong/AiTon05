...
public class AirCar extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView[] ActionBarTv = new TextView[2];
    ...
    private RelativeLayout mFlight_rela;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_air_car);
        initUI();
        setListener();
        addBookingCarInfos();
        /**
    ...
    private void setListener() {
        ...
        mFlight_rela.setOnClickListener(this);
    }
    ...
    private void initUI() {
        ...
        mFlight_rela = (RelativeLayout) findViewById(R.id.flight_rela);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.flight_rela:
                intent.setClass(AirCar.this,Flight.class);
            ...
            case R.id.Estimate_rella:
                intent.setClass(AirCar.this, EstimatePrice.class);
                startActivity(intent);
                break;
            ...
            case R.id.Collection01:
                intent.setClass(AirCar.this, UsedAddress.class);
            ...
            case R.id.booking:
                setActionBarTv(0);
                hideVoucherANDshowFlight();
                break;
            case R.id.halfday:
                setActionBarTv(1);

                showVoucherANDhideFlight();
                break;
            case R.id.call_car_forOther:
                intent.setClass(AirCar.this, CallCarForOthers.class);
                startActivity(intent);
                break;
    ...
    private void showVoucherANDhideFlight() {
        mFlight_rela.setVisibility(View.GONE);
        mVoucher.setVisibility(View.VISIBLE);
    }

    private void hideVoucherANDshowFlight() {
        mFlight_rela.setVisibility(View.VISIBLE);
        mVoucher.setVisibility(View.GONE);
    }
    private void setDialog() {
        View commit_dialog = getLayoutInflater().inflate(R.layout.commit_dialog, null);
        AlertDialog.Builder builder = new AlertDialog.Builder(AirCar.this);
    ...
    private void setActionBarTv(int a) {
        ...
        ActionBarTv[(a + 1) % 2].setTextColor(getResources().getColor(R.color.aiton_basic_color));
        ActionBarTv[a].setBackgroundResource(R.drawable.actionbar_select_tv_shape);
        ActionBarTv[(a + 1) % 2].setBackgroundResource(R.drawable.actionbar_unselect_tv_shape);
    }
    @Override
